...
class ReactElement extends HTMLElement {
  ...
  mount() {
    const propTypes = Button.propTypes ? Button.propTypes : {};
    const events = Button.propTypes ? Button.propTypes : {};
    const props = {
      ...this.getProps(this.attributes, propTypes),
      ...this.getEvents(events),
      children: this.parseHtmlToReact(this.innerHTML)
    };
    render(<Button {...props} />, this);
  }
...
customElements.define('react-btn', ReactElement);